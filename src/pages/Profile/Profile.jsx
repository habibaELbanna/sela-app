        ...
        {activeTab === 'overview' && (
          <div className='pf-tab-content'>
            ...
            <div className='pf-actions-grid'>
              ...
              <button
                className='pf-action-card pf-action-qc'
                onClick={() => navigate('/quality-check/3')}
              >
                <div className='pf-action-icon'>
                  <svg
                    width='22'
                ...
                <div className='pf-action-text'>
                  <span className='pf-action-label'>
                    {isAr ? 'فحص الجودة' : 'Quality Check'}
                  </span>
                  <span className='pf-action-sub'>
                    {isAr ? 'بالواقع المعزز' : 'AR-powered'}
                  </span>
                </div>
                <span className='pf-action-badge'>{isAr ? 'جديد' : 'NEW'}</span>
              </button>
            </div>
