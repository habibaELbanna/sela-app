...
const Profile = () => {
  ...
  const position =
    user?.job_title ||
    user?.position ||
    (isAr ? 'مدير مشروع أول' : 'Senior Project Manager')
  const companyName =
    (isAr ? company?.name_ar : company?.name_en) || 'BuildRight Construction'
            ...
            <div className='pf-stats-grid'>
              ...
              <div className='pf-stat-card'>
                ...
                <span className='pf-stat-value'>
                  {revenueMtd >= 1000
                    ? `EGP ${(revenueMtd / 1000).toFixed(0)}K`
                    : `EGP ${revenueMtd}`}
                </span>
                <span className='pf-stat-label'>
            ...
            <div className='pf-actions-grid'>
              ...
              >
                ...
                <span className='pf-action-label'>
                  {isAr ? 'تصفح الطلبات' : 'Browse Needs'}
                </span>
              </button>
              <button
                className='pf-action-card'
              ...
              <button
                className='pf-action-card'
                onClick={() => navigate('/discover-needs')}
              >
                <div className='pf-action-icon'>
                  <svg
                    width='22'
